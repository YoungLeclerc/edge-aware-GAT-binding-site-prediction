...
from utilis.data_encoding import categ_to_resnames


config_data = {
    'dataset_filepath': "data/datasets/contacts_rr5A_64nn_8192.h5",
    # 'dataset_filepath': "/tmp/"+sys.argv[-1]+"/contacts_rr5A_64nn_8192_mini.h5",
    'train_selection_filepath': "data/datasets/subunits_train_set.txt",
    'test_selection_filepath': "data/datasets/subunits_test_set.txt",
    'max_ba': 1,
    'max_size': 1024*8,
    'min_num_res': 48,
...
config_runtime = {
    ...
    'output_dir': 'save',
    'reload': False,
    'resume_checkpoint': 'model_checkpoint_255999.pt',
    'device': 'cuda',
    'num_epochs': 100,
    'batch_size': 1,
    'log_step': 1024,
